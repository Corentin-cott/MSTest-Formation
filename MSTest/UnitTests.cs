...
namespace MSTest
{
    ...
    public class UnitTests
    {
        ...
        public void TestGenMonstre()
        {
            ...
            Assert.IsInstanceOfType(monstre, typeof(Entitee)); // Si "monstre" n'est pas une instance de Entitee, le test échoue
        ...
        // Méthodes pour la class Entitee
        [TestMethod]
        public void TestJoueurAttaquer()
        {
            ...
            Combat combat = new(5);
            Entitee monstre = combat.GenMonstre();
            Entitee joueur = new(true, "JoueurTest", 100, 10, 5, 0);
        ...
        public void TestJoueurSeSoigner()
        {
            // Arrange
            Combat combat = new(5);
            Entitee joueur = new(true, "JoueurTest", 100, 10, 5, 10);
